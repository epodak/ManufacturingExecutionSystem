...
public class MenuThemeProcessor extends AbstractThemeProcessor {
	...
	private static final String BUNDLE_ID = "platform:/plugin/com.bafconsulting.e4.demo.contacts.javafx"; //$NON-NLS-1$
	private final static String PROCESSOR_ID = "com.bafconsulting.e4.demo.contacts.javafx.processors.theme.menu";
