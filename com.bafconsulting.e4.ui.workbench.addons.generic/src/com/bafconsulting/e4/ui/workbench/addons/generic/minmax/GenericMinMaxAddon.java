...
package com.bafconsulting.e4.ui.workbench.addons.generic.minmax;
...
import com.bafconsulting.e4.ui.workbench.generic.PresentationEngine;

@SuppressWarnings("restriction")
public class GenericMinMaxAddon {
	public static final String ADDONS_MINMAX_TRIM_STACK_ID = "com.bafconsulting.e4.ui.workbench.addons.generic.minmax.trimStackId";
	...
	private void createTrim(MUIElement element) {
		...
		if (trimStack == null) {
			...
			// command.setElementId("com.bafconsulting.e4.ui.workbench.addons.generic.minmax.restore");
			...
			// handler.setContributionURI("bundleclass://com.bafconsulting.e4.ui.workbench.addons.generic/com.bafconsulting.e4.ui.workbench.addons.generic.minmax.RestoreHandler");
			...
			// toolItem.setIconURI("platform:/plugin/com.bafconsulting.e4.ui.workbench.addons.generic/icons/fastview_restore.gif");
			...
			toolItem.setIconURI("platform:/plugin/com.bafconsulting.e4.ui.workbench.addons.generic/icons/fastview_restore.gif");
			toolItem.setContributionURI("bundleclass://com.bafconsulting.e4.ui.workbench.addons.generic/com.bafconsulting.e4.ui.workbench.addons.generic.minmax.RestoreHandler");
			...
			for (MUIElement stackElement : partStack.getChildren()) {
				...
				partItem.setContributionURI("bundleclass://com.bafconsulting.e4.ui.workbench.addons.generic/com.bafconsulting.e4.ui.workbench.addons.generic.minmax.FastViewHandler");
