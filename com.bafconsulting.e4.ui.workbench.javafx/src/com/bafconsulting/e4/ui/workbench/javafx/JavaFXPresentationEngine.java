...
import com.bafconsulting.e4.ui.workbench.generic.GenericPresentationEngine;
import com.bafconsulting.e4.ui.workbench.generic.RendererFactory;
	...
	public void postConstruct(IEclipseContext context) {
		...
		try {
			rendererFactory = (RendererFactory) contribFactory.create(
					"bundleclass://com.bafconsulting.e4.ui.workbench.renderers.javafx/"
							+ "com.bafconsulting.e4.ui.workbench.renderers.javafx.JavaFXRendererFactory", context);
		} catch (Exception e) {
